...
VALUES
    ...
    ('Analista de Log�stica',					1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 1),
    ...
    ('Operador de Almac�n',						1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 1),
    ('Inspector Aduanero',						1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 1),
    ('Analista de Documentaci�n',				1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 1),
    ('Asesor Comercial',						1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 0),
    ('Operario de M�quina de Tejido',			1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 0),
    ('T�cnico de Mantenimiento de Telares',		1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 0),
    ('Supervisor de Producci�n',				1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 0),
    ('Control de Calidad',						1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 0),
    ('Operario de Acabado',						1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 0),
    ('Jefe de L�nea de Producci�n',				1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 0),
    ('Ingeniero Textil',						1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 0),
    ('Auxiliar de Almac�n de Materias Primas',	1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 0),
    ('Dise�ador Textil',						1, '10-16-2004', NULL, NULL, NULL, NULL, 1, 0),
...
VALUES ('Operario',					1, GETDATE(), 0),
	   ('Supervisor de m�dulo',		1, GETDATE(), 0),
	   ('Coordinador de log�stica', 1, GETDATE(), 0),
...
VALUES ('TEGUCIGALPA, M.D.C.',		1, GETDATE()),
	   ('SAN PEDRO SULA, CORT�S',	1, GETDATE());
...
VALUES	-- Provinces for Argentina (AR)
		...
		('C�rdoba',			'CO', 11, 1, 1, GETDATE()),
		('Santa Fe',		'SF', 11, 1, 1, GETDATE()),
		('Mendoza',			'MZ', 11, 1, 1, GETDATE()),
		('Tucum�n',			'TU', 11, 1, 1, GETDATE()),
		
		-- Provinces for Brazil (BR)
		('S�o Paulo',			'SP', 32, 0, 1, GETDATE()),
		...
		('�le-de-France',			'IDF', 76, 0, 1, GETDATE()),
		('Auvergne-Rh�ne-Alpes',	'ARA', 76, 0, 1, GETDATE()),
		...
		('Baden-W�rttemberg',		'BW', 58, 1, 1, GETDATE()),
...
VALUES
	...
	('Lim�n', 66, 1, 1, GETDATE()),
	('Sab�', 66, 1, 1, GETDATE()),
	('Santa Fe', 66, 1, 1, GETDATE()),
	('Santa Rosa de Agu�n', 66, 1, 1, GETDATE()),
	...
	('San Jer�nimo', 67, 1, 1, GETDATE()),
	('San Jos� de Comayagua', 67, 1, 1, GETDATE()),
	('San Jos� del Potrero', 67, 1, 1, GETDATE()),
	('San Luis', 67, 1, 1, GETDATE()),
	('San Sebasti�n', 67, 1, 1, GETDATE()),
	('Siguatepeque', 67, 1, 1, GETDATE()),
	('Villa de San Antonio', 67, 1, 1, GETDATE()),
	('Las Lajas', 67, 1, 1, GETDATE()),
	('Taulab�', 67, 1, 1, GETDATE()),
	('Santa Rosa de Cop�n', 68, 1, 1, GETDATE()),
	('Caba�as', 68, 1, 1, GETDATE()),
	('Concepci�n', 68, 1, 1, GETDATE()),
	('Cop�n Ruinas', 68, 1, 1, GETDATE()),
	('Corqu�n', 68, 1, 1, GETDATE()),
	('Cucuyagua', 68, 1, 1, GETDATE()),
	('Dolores', 68, 1, 1, GETDATE()),
	('Dulce Nombre', 68, 1, 1, GETDATE()),
	('El Para�so', 68, 1, 1, GETDATE()),
	('Florida', 68, 1, 1, GETDATE()),
	('La Jigua', 68, 1, 1, GETDATE()),
	('La Uni�n', 68, 1, 1, GETDATE()),
	('Nueva Arcadia', 68, 1, 1, GETDATE()),
	('San Agust�n', 68, 1, 1, GETDATE()),
	('San Antonio', 68, 1, 1, GETDATE()),
	('San Jer�nimo', 68, 1, 1, GETDATE()),
	('San Jos�', 68, 1, 1, GETDATE()),
	('San Juan de Opoa', 68, 1, 1, GETDATE()),
	('San Nicol�s', 68, 1, 1, GETDATE()),
	('San Pedro', 68, 1, 1, GETDATE()),
	('Santa Rita', 68, 1, 1, GETDATE()),
	('Trinidad de Cop�n', 68, 1, 1, GETDATE()),
	...
	('Puerto Cort�s', 69, 1, 1, GETDATE()),
	('San Antonio de Cort�s', '69', 1, 1, GETDATE()),
	...
	('Santa Luc�a', 72, 1, 1, GETDATE()),
	('Talanga', 72, 1, 1, GETDATE()),
	('Tatumbla', 72, 1, 1, GETDATE()),
	('Valle de �ngeles', 72, 1, 1, GETDATE()),
	...
	('Bel�n Gualcho', 78, 1, 1, GETDATE()),
	('Concepci�n', 78, 1, 1, GETDATE()),
	('Dolores Merend�n', 78, 1, 1, GETDATE()),
	('Fraternidad', 78, 1, 1, GETDATE()),
	('La Encarnaci�n', 78, 1, 1, GETDATE()),
	...
	('Protecci�n', 80, 1, 1, GETDATE()),
	('Quimist�n', 80, 1, 1, GETDATE()),
	('San Francisco de Ojuera', 80, 1, 1, GETDATE()),
	('San Jos� de las Colinas', 80, 1, 1, GETDATE()),
	('San Luis', 80, 1, 1, GETDATE()),
	('San Marcos', 80, 1, 1, GETDATE()),
	('San Nicol�s', 80, 1, 1, GETDATE()),
...
VALUES	('Colonia Trejo', NULL, 63, 1,GETDATE()),
		...
		('Colonia Sat�lite', NULL, 63, 1,GETDATE()),
		...
		('Colonia Brisas de Chamelec�n', NULL, 64, 1,GETDATE()),
		...
		('Colonia Mej�a Fiallos', NULL, 19, 1,GETDATE()),
		...
		('Colonia San Mart�n', NULL, 19, 1,GETDATE()),
		...
		('Colonia Victor Arge�al', NULL, 75, 1,GETDATE()),
		...
		('Colonia Divino Para�so', NULL, 110, 1,GETDATE()),
		...
		('Colonia El Volc�n', NULL, 212, 1,GETDATE()),
		('Colonia La Comunidad', NULL, 212, 1,GETDATE()),
		('Colonia Pie del Cerro', NULL, 212, 1,GETDATE()),
		('Colonia San Jos� de la Reuni�n', NULL, 212, 1,GETDATE()),
		...
		('Colonia Espa�a', NULL, 288, 1,GETDATE()),
		('Colonia Pinos', NULL, 288, 1,GETDATE()),
		('Colonia Jerusalen', NULL, 288, 1,GETDATE()),
		('Colonia Porfirio Mart�nez', NULL, 288, 1,GETDATE()),
...
VALUES	('EUR', 'COMUNIDAD EUROPEA, EURO', 1, 1,  GETDATE()),
		...
		('AWG', 'ARUBA, FLORIN ARUBE�O', 1, 1,  GETDATE()),
		...
		('MZN', 'MOZAMBIQUE, METICAL MOZAMBIQUE�O', 1, 1,  GETDATE()),
