...
VALUES	-- Provinces for Argentina (AR)
		...
		('Île-de-France',			'IDF', 76, 0, 1, GETDATE()),
		('Auvergne-Rhône-Alpes',	'ARA', 76, 0, 1, GETDATE()),
		...
		('Baden-Württemberg',		'BW', 58, 1, 1, GETDATE()),
...
VALUES
	...
	('Lamaní', 67, 1, 1, GETDATE()),
	('La Trinidad', 67, 1, 1, GETDATE()),
	('Lejamaní', 67, 1, 1, GETDATE()),
	('Meámbar', 67, 1, 1, GETDATE()),
	...
	('Morocelí', 71,  1, 1, GETDATE()),
	('Oropolí', 71, 1, 1, GETDATE()),
	...
	('Alubarén', 72, 1, 1, GETDATE()),
	('Cedros', 72, 1, 1, GETDATE()),
	('Curarén', 72, 1, 1, GETDATE()),
	...
	('Tomalá', 77, 1, 1, GETDATE()),
	('Valladolid', 77, 1, 1, GETDATE()),
	('Virginia', 77, 1, 1, GETDATE()),
	('San Marcos de Caiquín', 77, 1, 1, GETDATE()),
	...
	('Dulce Nombre de Culmí', 79, 1, 1, GETDATE()),
