            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Aduanas', style: 'header', margin: [0, 40, 0,20] },
                    ],
                    styles: {
                        header: {
                            fontSize: 26,
                    ...
                    
                    {
                        table: {
                            ...
                            body: [
                                ...
                                {text:'Código de la aduana', style: 'tableHeader'},
                                {text:'Nombre de la aduana', style: 'tableHeader'},
                                {text:'Dirección exacta', style: 'tableHeader'},
                            ],
                                ...data.map((item) => [item.key, item.adua_Codigo, item.adua_Nombre, item.adua_Direccion_Exacta ]),
                            ],
                            alignment: 'center'
                        },
                    },
