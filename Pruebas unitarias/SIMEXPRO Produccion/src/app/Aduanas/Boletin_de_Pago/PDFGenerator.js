            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Boletines de pago', style: 'header', margin: [0, 40, 0, 20] },
                    ],
                    styles: {
                        header: {
                            fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    { text: 'No. de declaración', style: 'tableHeader' },
                                    { text: 'Preimpreso', style: 'tableHeader' },
                                    { text: 'Total a pagar', style: 'tableHeader' },
                                ],
                                ...data.map((item) => [item.key, item.boen_NDeclaracion, item.boen_Preimpreso, item.boen_TotalPagar]),
                            ],
                            alignment: 'center'
                        },
                    },
