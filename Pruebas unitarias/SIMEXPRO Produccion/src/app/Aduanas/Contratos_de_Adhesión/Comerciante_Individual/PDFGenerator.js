            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Contratos de Adhesión Comerciante Individual', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                    ...
                    
                    {
                        table: {
                            ...
                            body: [
                                ...
                                {text:'RTN del comerciante', style: 'tableHeader'},
                                {text:'Oficio o profesión del comerciante', style: 'tableHeader'},
                                {text:'Oficina a presentar la solicitud', style: 'tableHeader'},
                            ],
                                ...data.map((item) => [item.key, item.pers_RTN, item.ofpr_Nombre, item.ofic_Nombre ]),
                            ],
                            alignment: 'center'
                        },
                    },
