...
function Persona_JuridicaReporte() {
...
//   };
  ...
  const MyDoc = () => (
    <Document title="ContratoDeAdhesion.pdf" creator="SIMEXPRO" author="SIMEXPRO">
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.columnsContainer3}>
          <Text style={styles.detallesTitle}>CONTRATO DE ADHESIÓN DE OBLIGADO TRIBUTARIO NO. <Text style={styles.prueba}> {data["peju_Id"]}  </Text></Text>
        </View>
        ...
        <View style={styles.tableContainerTransparente}>
          ...
          <View >
            <View>
              <View>
              <Text style={styles.ini}>Yo <Text style={styles.prueba}> _{data["pers_Nombre"]}_</Text>,  con RTN No. <Text style={styles.prueba}>   {data["pers_RTN"]}</Text>, con domicilio fiscal de la persona natura (departamento
                y  Ciudad) <Text style={styles.prueba}>  {data["provinciaEmpresa"]} - {data["ciudadEmpresa"]}</Text>, (colonia, bloque, calle, casa)  <Text style={styles.prueba}>    {data["coliniaEmpresa"]} - {data["peju_NumeroLocalApart"]}   </Text>,
                con número  de celular / teléfono <Text style={styles.prueba}>  {data["peju_TelefonoFijoRepresentanteLegal"]}   </Text>, actuando en mi condición de Persona Juridica, lo cual acredito con copia adjunta de Declaración Persona 
                Juridica, y estando en el pleno ejercicio de mis derechos civiles, libre y espontáneamente manifiesto mi Adhesión a las siguientes condiciones de uso de la Plataforma Electrónica de
                Comercio de Honduras ante la Administración Aduanera, consistiendo en: </Text>
              </View>
      
              <View style={styles.columnsContainer3}>
                <Text style={styles.inicio}>Declaro que los datos proporcionados en el presente contrato son verídicos, y designo el correo electrónico: <Text style={styles.prueba}>  {data["peju_CorreoElectronico"]}   </Text>
              ...
              <View style={styles.columnsContainer3}>
                <Text style={styles.inicio2}>CLAÚSULA SEGUNDA: Reconozco que las comunicaciones/ notificaciones y demás datos transmitidos
              ...
              <View style={styles.columnsContainer3}>
                <Text style={styles.inicio3}>CLAÚSULA TERCERA: Declaro que los documentos que adjunto al presente contrato y los que anexe a cualquier petición,
              ...
              <View style={styles.columnsContainer3}>
                <Text style={styles.inicio4}>CLAÚSULA CUARTA: Reconozco mi obligación de comunicar y actualizar ante la Administración Aduanera cualquier cambio en relación con mis datos personales incluyendo
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.tableContainerTransparente}>
          ...
          <View >
            <View>      
              <View style={styles.columnsContainer3}>
                <Text style={styles.inicio}>CLAÚSULA QUINTA: Para todas las gestiones realizadas mediante el sistema de gestión y transmisión de información sobre peticiones a la Administración Aduanera, se observará todo
              ...
              <View style={styles.columnsContainer3}>
                <Text style={styles.inicio2}>CLAÚSULA SEXTA: El presente Contrato de Adhesión tendrá vigencia por un año a partir de la fecha en que suscribo el mismo y acepto que el mismo se renueve por el mismo plazo de 
              ...
              <View style={styles.columnsContainer321}>
                <Text style={styles.inicio42}>Aceptado  por  la  Administración  Aduanera  en  la  ciudad  de <Text style={styles.prueba}>  {data["ofic_Nombre"]}  </Text>,</Text>
...
export default Persona_JuridicaReporte;
