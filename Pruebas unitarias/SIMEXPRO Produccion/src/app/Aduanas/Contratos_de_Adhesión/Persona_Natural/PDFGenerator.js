            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Contratos de Adhesión Persona Natural', style: 'header', margin: [20, 80, 0, 20] },
                    ],
                    ...
                    table: {
                        ...
                        body: [
                            [
                                ...
                                { text: 'Nombre de la persona', style: 'tableHeader' },
                                { text: 'RTN de la persona', style: 'tableHeader' },
                                { text: 'Teléfono celular', style: 'tableHeader' },
                                { text: 'DNI de la persona', style: 'tableHeader' },
                            ],
                            ...data.map((item) => [item.key, item.cliente, item.pena_RTN, item.pena_TelefonoCelular, item.pena_DNI]),
                        ],
                        alignment: 'center',
                    },
                });
