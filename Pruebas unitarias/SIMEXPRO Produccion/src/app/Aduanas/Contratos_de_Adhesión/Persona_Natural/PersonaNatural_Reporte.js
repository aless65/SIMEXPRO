...
function PersonaNaturalReporte() {

    const location = useLocation();
    const DatosPrincipales = location.state;
    const [dataDetalle, setdataDetalle] = useState([]);
    const Regresar = () => {
        History.push("/PersonaNatural/index");
    };
    ...
    const MyDoc = () => (
    <Document title="ContratoAdhesiónReporte" creator="SIMEXPRO" author="SIMEXPRO">
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.columnsContainer3}>
          <Text style={styles.detallesTitle}>CONTRATO DE ADHESIÓN DE OBLIGADO TRIBUTARIO NO. {DatosPrincipales.pena_Id}</Text>
        </View>
        ...
        <View style={styles.tableContainerTransparente}>
          ...
          <View >
            <View>
              <View>
              <Text style={styles.ini}>Yo <Text style={styles.prueba} >   { DatosPrincipales.cliente}   </Text>,  con no. de identidad <Text style={styles.prueba} >   { DatosPrincipales.pena_DNI}   </Text> y RTN No. <Text style={styles.prueba} >  {DatosPrincipales.pena_RTN}  </Text>, con domicilio fiscal de la persona natura (departamento
                y  Ciudad) <Text style={styles.prueba} >  {DatosPrincipales.pvin_Nombre} , {DatosPrincipales.ciud_Nombre}  </Text>, (colonia, bloque, calle, casa) <Text style={styles.prueba} >  {DatosPrincipales.pena_DireccionExacta}  </Text> ,
                con número  de celular / teléfono<Text style={styles.prueba} >  {DatosPrincipales.pena_TelefonoFijo}  </Text> , actuando en mi condición de Comerciante Individual, lo cual acredito con copia adjunta de Declaración Comerciante 
              ...
              <View style={styles.columnsContainer3}>
                <Text style={styles.inicio}>Declaro que los datos proporcionados en el presente contrato son verídicos, y designo el correo electrónico:<Text style={styles.prueba} >  {DatosPrincipales.pena_CorreoElectronico}  </Text> 
          ...
          <View >
            <View>      
              ...
              <View style={styles.columnsContainer321}>
                <Text style={styles.inicio42}>Aceptado  por  la  Administración  Aduanera  en  la  ciudad  de <Text style={styles.prueba}>  {DatosPrincipales["ofic_Nombre"]}  </Text>,</Text>
...
export default PersonaNaturalReporte;