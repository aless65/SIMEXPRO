            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'DUCA(Declaración Única Centroamericana)', style: 'header', margin: [20, 80, 0, 20] },
                    ],
                    styles: {
                        header: {
                            fontSize: 26,
                    ...
                    table: {
                        ...
                        body: [
                            [
                                ...
                                { text: 'No. de DUCA', style: 'tableHeader' },
                                { text: 'No. correlativo o referencia', style: 'tableHeader' },
                                { text: 'País de procedencia', style: 'tableHeader' },
                                { text: 'Aduana de Registro', style: 'tableHeader' },
                            ],
                            ...data.map((item) => [
                                item.key || 'No disponible',
                                item.duca_No_Duca || 'No disponible',
                                item.duca_No_Correlativo_Referencia || 'No disponible',
                                item.nombre_pais_procedencia || 'No disponible',
                                item.nombre_Aduana_Registro || 'No disponible',
                            ]),
                        ],
                        alignment: 'center',
                    },
