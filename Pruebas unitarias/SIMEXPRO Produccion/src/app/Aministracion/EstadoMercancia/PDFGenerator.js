            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Estados de Mercancías', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                    ...
                    
                    {
                        table: {
                            ...
                            body: [
                                ...
                                {text:'Código del estado de mercancía', style: 'tableHeader'},
                                {text:'Nombre del estado de mercancía', style: 'tableHeader'},
                            ],
                                ...data.map((item) => [item.key, item.merc_Codigo, item.merc_Descripcion]),
                           ],
                            alignment: 'center'
                        },
                    },
