            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Lugares de Embarque', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Código del lugar de embarque', style:'tableHeader'},
                                    {text: 'Nombre del lugar de embarque', style:'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.emba_Codigo, item.emba_Descripcion])
                            ],
                            alignment: 'center'
                        },
                    },
