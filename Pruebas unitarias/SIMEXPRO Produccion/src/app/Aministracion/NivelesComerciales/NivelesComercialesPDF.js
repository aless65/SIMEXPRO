            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Niveles Comerciales', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Código del nivel comercial', style:'tableHeader'},
                                    {text: 'Descripción del nivel comercial', style:'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.nico_Codigo,item.nico_Descripcion])
                            ],
                            alignment: 'center'
                        },
                    },
