            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Regímenes Aduaneros', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Código del régimen aduanero', style:'tableHeader'},
                                    {text: 'Nombre del régimen aduanero', style:'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.regi_Codigo ,item.regi_Descripcion])
                            ],
                            alignment: 'center'
                        },
                    },
