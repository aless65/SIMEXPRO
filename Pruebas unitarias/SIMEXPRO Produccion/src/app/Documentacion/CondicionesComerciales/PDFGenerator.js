            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Condiciones Comerciales', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Abreviatura de la condición comercial',  style:'tableHeader'},
                                    {text: 'Nombre de la condición comercial', style:'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.coco_Codigo, item.coco_Descripcion ]),
                            ],
                            alignment: 'center'
                        },
                    },
