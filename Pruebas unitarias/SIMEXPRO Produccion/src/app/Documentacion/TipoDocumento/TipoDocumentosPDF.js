            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Tipos de Documento', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Código del tipo de documento', style:'tableHeader'},
                                    {text: 'Nombre del tipo de documento', style:'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.tido_Codigo, item.tido_Descripcion])
                            ],
                            alignment: 'center'
                        },
                    },
