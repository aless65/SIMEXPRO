            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Formas de envío', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                    ...
                    
                    {
                        table: {
                            ...
                            body: [
                                ...
                                {text:'Código de la forma de envío', style: 'tableHeader'},
                                {text:'Nombre de la forma de envío', style: 'tableHeader'}
                            ],
                                ...data.map((item) => [item.key, item.foen_Codigo, item.foen_Descripcion]),
                            ],
                            alignment: 'center'
                        },
                    },
