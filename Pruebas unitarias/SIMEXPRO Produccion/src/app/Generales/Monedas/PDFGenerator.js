            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Monedas', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                    ...
                    
                    {
                        ...
                        body: [
                            [
                                ...
                                {text:'Código de la moneda', style: 'tableHeader'},
                                {text:'Nombre de la moneda', style: 'tableHeader'},],
                            ...data.map((item) => [item.key, item.mone_Codigo, item.mone_Descripcion]),
                        ],
                        alignment: 'center',
                        },
                    },
