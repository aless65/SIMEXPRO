            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Tipos de Identificación', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text:'Descripción del tipo de identificación', style: 'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.iden_Descripcion])
                            ],
                            alignment: 'center'
                        },
                    },
