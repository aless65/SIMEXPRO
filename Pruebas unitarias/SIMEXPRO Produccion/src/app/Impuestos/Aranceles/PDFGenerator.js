            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Aranceles', style: 'header', margin: [0, 40, 0,20] },
                    ],
                    styles: {
                        header: {
                            fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Código del arancel', style: 'tableHeader'},
                                    {text: 'Descripción del arancel', style: 'tableHeader'},
                                ],
                                ...data.map((item) => [item.key,item.aran_Codigo, item.aran_Descripcion]),
                           ],
                            alignment: 'center'
                        },
                    },
