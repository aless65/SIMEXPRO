            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Códigos de impuesto', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text:'Descripción del código de impuesto', style: 'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.coim_Descripcion]),
                           ],
                            alignment: 'center'
                        },
                    },
