            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Conceptos de pago', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                    ...
                    
                    {
                        table: {
                            ...
                            body: [
                                ...
                                {text:'Descripción del concepto de pago', style: 'tableHeader'},
                            ],
                                ...data.map((item) => [item.key, item.copa_Descripcion]),
                           ],
                            alignment: 'center'
                        },
                    },
