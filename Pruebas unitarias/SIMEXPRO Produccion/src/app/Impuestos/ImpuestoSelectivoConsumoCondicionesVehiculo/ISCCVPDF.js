            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Impuesto Selectivo al Consumo - Condiciones Vehiculares', style: 'header', margin: [0, 40, 0, 20] },
                    ],
                    styles: {
                        header: {
                            fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    { text: '¿Es vehículo nuevo?', style: 'tableHeader' },
                                    { text: 'Cantidad inicial del rango', style: 'tableHeader' },
                                    { text: 'Cantidad final del rango', style: 'tableHeader' },
                                    { text: 'Impuesto a cobrar', style: 'tableHeader' },
                                ],
                                ...data.map((item) => 
                                [
                                    item.key,
