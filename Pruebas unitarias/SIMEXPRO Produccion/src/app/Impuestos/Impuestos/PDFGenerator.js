            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Impuestos', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text:'Descripción del impuesto', style:'tableHeader'},
                                    {text:'Porcentaje a pagar', style:'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.impu_Descripcion, item.impu_Cantidad])
                            ],
                            alignment: 'center'
                        },
                    },
