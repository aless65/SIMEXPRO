            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Incoterms', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Código del incoterm', style:'tableHeader'},
                                    {text: 'Descripción del incoterm',style:'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.inco_Codigo ,item.inco_Descripcion])
                            ],
                            alignment: 'center'
                        },
                    },
