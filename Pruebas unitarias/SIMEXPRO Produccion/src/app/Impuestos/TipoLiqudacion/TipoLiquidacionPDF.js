            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Tipos de Liquidación', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Descripción del tipo de liquidación', style:'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.tipl_Descripcion])
                            ],
                            alignment: 'center'
                        },
                    },
