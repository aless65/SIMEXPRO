            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Lotes', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Cantidad actual', style: 'tableHeader'}, 
                                ],
                                ...data.map((item) => 
                                [item.key, item.unme_Descripcion, item.mate_Descripcion, item.tipa_area, item.lote_Stock]
                                )
                            ],
                            alignment: 'center'
                        },
