            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Materiales', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Nombre del Material', style: 'tableHeader'}, 
                                    {text: 'Nombre de la Subcategoria', style: 'tableHeader'}
                                ],
                                ...data.map((item) => 
                                    [item.key, item.mate_Descripcion, item.subc_Descripcion]
                                )
                            ],
                            alignment: 'center'
                        },
