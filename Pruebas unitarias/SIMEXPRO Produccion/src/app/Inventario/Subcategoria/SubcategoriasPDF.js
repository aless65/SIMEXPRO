            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Subcategorías de Materiales', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Nombre de la Subcategoría', style: 'tableHeader'}, 
                                    {text: 'Nombre de la Categoría', style: 'tableHeader'}
                                ],
                                ...data.map((item) => [item.key, item.subc_Descripcion, item.cate_Descripcion])
                            ],
                            alignment: 'center'
                        },
                    },
