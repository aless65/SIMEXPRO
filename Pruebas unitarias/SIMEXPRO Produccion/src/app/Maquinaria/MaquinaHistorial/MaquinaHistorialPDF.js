            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Historial de Máquinas', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'No. de serie de Máquina', style: 'tableHeader'}, 
                                    {text: 'Fecha Inicio', style: 'tableHeader'}, 
                                    {text: 'Fecha Fin', style: 'tableHeader'}, 
                                ],
                                ...data.map((item) => [item.key, item.maquinaNumeroSerie, item.mahi_FechaInicio, item.mahi_FechaFin])
                            ],
                            alignment: 'center'
                        },
                    },
