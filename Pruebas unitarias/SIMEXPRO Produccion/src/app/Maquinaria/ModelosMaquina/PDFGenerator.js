            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Modelos de Máquina', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text:'Marca de la máquina', style: 'tableHeader'},
                                    {text:'Función de la máquina', style: 'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.mmaq_Nombre, item.marq_Nombre, item.func_Nombre]),
                            ],
                            alignment: 'center'
                        },
                    },
