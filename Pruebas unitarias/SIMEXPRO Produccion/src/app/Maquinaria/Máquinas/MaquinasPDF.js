            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Máquinas', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'No. de serie de la máquina', style: 'tableHeader'}, 
                                    {text: 'Modelo de la máquina', style: 'tableHeader'}, 
                                    {text: 'Módulo de la máquina', style: 'tableHeader'}
                                ],
                                ...data.map((item) => [item.key, item.maqu_NumeroSerie, item.mmaq_Nombre, item.modu_Nombre])
                            ],
                            alignment: 'center'
                        },
                    },
