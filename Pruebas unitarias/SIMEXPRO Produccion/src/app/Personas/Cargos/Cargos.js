...
function CargosIndex() {
 ...
 const cargosService = CargosService();
...
const csvExporter = new ExportToCsv(csvOptions);
  ...
  const CargosGetData = async () => {
    try {
      ...
      SetExportData(await cargosService.ExportData());
    } catch (error) {
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={8}>
                <FormControl fullWidth>
                  <FormLabel error={!!errors.carg_Nombre}>Nombre del cargo:</FormLabel>
                  <Controller
                    render={({ field }) => (
                      <TextField
                        {...field}
