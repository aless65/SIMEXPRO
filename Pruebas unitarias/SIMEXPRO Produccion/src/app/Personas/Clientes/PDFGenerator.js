            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Clientes', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                    ...
                    
                    {
                        table: {
                            ...
                            body: [
                                ...
                                {text:'Nombre o razón social', style: 'tableHeader'},
                                {text:'RTN del cliente', style: 'tableHeader'},
                                {text:'Nombre de contacto', style: 'tableHeader'},
                                {text:'Correo electrónico', style: 'tableHeader'},                            
                            ],
                                ...data.map((item) => [item.key,item.clie_Nombre_O_Razon_Social, item.clie_RTN, item.clie_Nombre_Contacto, item.clie_Correo_Electronico]),
                            ],
                            alignment: 'center'
                        },
                    },
