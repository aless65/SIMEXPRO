            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Empleados', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                    ...
                    
                    {
                        table: {
                           ...
                           body: [
                               ...
                               {text:'DNI del empleado', style: 'tableHeader'},
                               {text:'Estado civíl del empleado', style: 'tableHeader'},
                               {text:'Sexo del empleado', style: 'tableHeader'},
                               {text:'Cargo asignado', style: 'tableHeader'},
                               {text:'Estado del empleado', style: 'tableHeader'},

                            ],
                               ...data.map((item) => [item.key, item.empl_NombreCompleto, item.empl_DNI,item.escv_Nombre,item.empl_Sexo,item.carg_Nombre, item.empl_Estado == 0 ? 'Deshabilitado' : 'Habilitado']),
                            ],
                            alignment: 'center'
                        },
                    },
