            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Proveedores', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                    ...
                    
                    {
                        table: {
                            ...
                            body: [
                                ...
                                {text:'Nombre de la compañía', style: 'tableHeader'},
                                {text:'Nombre del contacto', style: 'tableHeader'},
                                {text:'Teléfono del proveedor', style: 'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.prov_NombreCompania, item.prov_NombreContacto, item.prov_Telefono]),
                            ],
                            alignment: 'center'
                        },
                    },
