            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Tipos de Intermediario', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                    ...
                    
                    {
                        table: {
                            ...
                            body: [
                                ...
                                {text:'Código de intermediario', style: 'tableHeader'},
                                {text:'Tipo de intermediario', style: 'tableHeader'},
                            ],
                                ...data.map((item) => [item.key, item.tite_Codigo, item.tite_Descripcion]),
                            ],
                            alignment: 'center'
                        },
                    },
