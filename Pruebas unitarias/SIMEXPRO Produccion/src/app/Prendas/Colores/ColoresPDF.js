            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Colores', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Nombre del color', style: 'tableHeader'},
                                    {text: 'Código del color', style: 'tableHeader'},

                                ],
                                ...data.map((item) => [item.key, item.colr_Nombre, item.colr_Codigo])
                            ],
                            alignment: 'center'
                        },
                    },
