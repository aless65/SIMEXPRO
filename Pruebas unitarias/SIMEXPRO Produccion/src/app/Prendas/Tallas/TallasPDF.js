            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Tallas', style: 'header', margin: [0, 40, 0, 20] },
                    ],
                    styles: {
                        header: {
                            fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    { text: 'Código de la talla', style: 'tableHeader' },
                                    { text: 'Descripción de la talla', style: 'tableHeader' }
                                ],
                                ...data.map((item) => [item.key, item.tall_Codigo, item.tall_Nombre])
                            ],
                            alignment: 'center'
                        },
                    },
