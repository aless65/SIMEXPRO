            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Impuesto', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Nombre del Impuesto', style: 'tableHeader'}, 
                                    {text: 'Valor del impuesto', style: 'tableHeader'}
                                ],
                                ...data.map((item) => [item.key, item.impr_Descripcion, item.impr_Valor])
                            ],
                            alignment: 'center'
                        },
                    },
