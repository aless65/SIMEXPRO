            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Módulos', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Nombre del módulo', style: 'tableHeader'}, 
                                    {text: 'Proceso asignado', style: 'tableHeader'}, 
                                    {text: 'Nombre del encargado', style: 'tableHeader'}
                                ],
                                ...data.map((item) => [item.key, item.modu_Nombre, item.proc_Descripcion, item.empl_NombreCompleto])
                            ],
                            alignment: 'center'
                        },
                    },
