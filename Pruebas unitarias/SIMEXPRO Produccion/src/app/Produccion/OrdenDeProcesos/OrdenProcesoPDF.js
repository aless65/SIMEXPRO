            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Ordenes de Proceso', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Empleado Encargado', style:'tableHeader'}, 
                                ...
                                ...data.map((item) => [item.key, item.ensa_Cantidad, item.empl_NombreCompleto, item.code_Sexo, item.esti_Descripcion, item.ensa_FechaInicio, item.ensa_FechaLimite]),
                            ],
                            alignment: 'center'
                        },
                    },
