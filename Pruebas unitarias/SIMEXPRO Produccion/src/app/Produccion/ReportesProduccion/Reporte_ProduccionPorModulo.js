...
function Reporte_ProduccionPorModulo() {
  ...
  const getdata = async (fechainicio, fechafin) => {
    try {
      ...
      const data = await reportesProduccionService.ProduccionPorModulo(fechainicio, fechafin);
      setData(data);
      const labels = [];
      const datasets = [];

      data.forEach((datos) => {
        labels.push(datos.modu_Nombre);
        datasets.push(datos.promedioProduccion);
      });
  ...
  const MyDoc = () => (
    <Document title="ReporteEficienciaModulo.pdf" creator="SIMEXPRO" author="SIMEXPRO">
      <Page size="A4" style={{ ...styles.page }}>
        ...
        <View style={styles.columnsContainer3} fixed>
          <Text style={styles.detallesTitle}>Reporte Eficiencia de Modulo</Text>
                ...
                <View style={{ ...styles.tableContainerTransparente, textTransform: 'uppercase' }}>
                  ...
                  >
                    <View style={styles.tableCellRegistors}>
                      <Text style={styles.cellText}>Promedio Prendas Completadas por día</Text>
                    </View>
                    <View style={styles.tableCellRegistors}>
                      <Text style={styles.cellText}>Promedio Prendas Dañadas por día</Text>
                    </View>
                    <View style={styles.tableCellRegistors}>
                      <Text style={styles.cellText}>Porcentaje Producción</Text>
                    </View>
                    <View style={styles.tableCellRegistors}>
                      <Text style={styles.cellText}>Total Producido</Text>
                    </View>
                  </View>

                  <View
                    key={Index}
                    style={[styles.tableRow, { backgroundColor: Index % 2 === 0 ? '#fff' : '#fff' }]}
                  >
                    <View style={styles.tableCellRegistors}>
                      <Text style={styles.cellText}>{datos.promedioCantidad}</Text>
                    </View>
                    <View style={styles.tableCellRegistors}>
                      <Text style={styles.cellText}>{datos.promedioDanio}</Text>
                    </View>
                    <View style={styles.tableCellRegistors}>
                    <Text style={styles.cellText}>{datos.promedioProduccion.toFixed(2)}</Text>
                    </View>
                    <View style={styles.tableCellRegistors}>
                      <Text style={styles.cellText}>{datos.totalProduccion}</Text>
                    </View>
                  </View>
                </View>
    ...
    <>
      <Card sx={{ minWidth: 275, margin: '40px' }}>
        <CardMedia
          ...
          height="200"
          className="mb-24"
          image="https://i.ibb.co/8mTwN2f/EFICIENCIA-POR-M-DULO-1.png"
...
export default Reporte_ProduccionPorModulo;
