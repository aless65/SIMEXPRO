            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Usuarios', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                    ...
                    
                    {
                        table: {
                            ...
                            body: [
                                ...
                                {text:'Nombre del usuario', style: 'tableHeader'},
                                {text:'Nombre del empleado', style: 'tableHeader'},
                                {text:'Rol asignado', style: 'tableHeader'},
                                {text:'Estado del usuario', style: 'tableHeader'},
                            ],
                                ...data.map((item) => [item.key, item.usua_Nombre, item.emplNombreCompleto, item.role_Descripcion, item.usua_Estado ? 'Activo' : 'Inactivo']),
                            ],
                            alignment: 'center'
                        },
                    },
