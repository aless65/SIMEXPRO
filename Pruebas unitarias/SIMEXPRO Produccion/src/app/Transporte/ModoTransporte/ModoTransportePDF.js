            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Modos de Transporte', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {text: 'Descripción del modo de transporte', style:'tableHeader'},
                                ],
                                ...data.map((item) => [item.key, item.motr_Descripcion])
                            ],
                            alignment: 'center'
                        },
                    },
