            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Ciudades', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                    ...
                    
                    {
                        table: {
                            ...
                            body: [
                                ...
                                {text:'Nombre de la Ciudad', style: 'tableHeader'},
                                {text:'Provincia a la que pertenece', style: 'tableHeader'},
                                {text:'País al que pertenece', style: 'tableHeader'},
                            ],
                                ...data.map((item) => [item.key, item.ciud_Nombre, item.pvin_Nombre, item.pais_Nombre]),
                            ],
                            alignment: 'center'
                        },
                    },
