            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Colonias', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                    ...
                    
                    {
                        table: {
                            ...
                            body: [
                                ...
                                {text:'Nombre de la colonia', style: 'tableHeader'},
                                {text:'Ciudad a la que pertenece', style: 'tableHeader'},
                            ],
                                ...data.map((item) => [item.key,  item.colo_Nombre, item.ciud_Nombre  ]),
                            ],
                            alignment: 'center'
                        },
                    },
