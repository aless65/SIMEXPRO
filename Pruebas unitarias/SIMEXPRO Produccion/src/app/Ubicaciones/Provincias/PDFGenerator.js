            ...
            reader.onload = () => {
                ...
                const docDefinition = {
                    content: [
                        ...
                        { text: 'Provincias', style: 'header', margin: [0, 40, 0,20] },
                    ],
                styles: {
                    header: {
                        fontSize: 26,
                ...
                docDefinition.content.push(
                    {
                        ...
                        body: [
                            [
                                ...
                                {text: 'Código de la provincia',style:'tableHeader'},
                                {text: 'Nombre de la provincia', style:'tableHeader'},
                                {text: 'País al que pertenece',style:'tableHeader'},
                            ],
                            ...data.map((item) => [item.key, item.pvin_Codigo,item.pvin_Nombre ,item.pais_Nombre ]),
                        ],
                        alignment: 'center',
                        },
                    },
