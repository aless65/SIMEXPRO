...
function RecentTransactionsWidget(props) {
  ...
  return (
    // <Card className="flex flex-col flex-auto p-12 shadow rounded-2xl overflow-hidden">
    <Card >
      {/* <div className="">
      ...
      {/* <Card sx={{ minWidth: 275, margin: "40px" }}> */}
        <CardMedia
          component="img"
          height="200"
          image="https://i.ibb.co/wWfJJfY/inicio.png"
        ...
        >
          {/* <Image
            src="https://i.ibb.co/7k7tKm2/SIMEXPRO.png"
            height={"35vh"}
          ></Image> */}
          <img
            style={{ height: "35vh" }}
        ...
        >
          {/* <Image
            src="https://i.ibb.co/XJyFdVJ/SIMEXPRO-COMPACTO.png"
            height={"55vh"}
          ></Image> */}
          <img
            style={{ height: "55vh" }}
            src="https://i.ibb.co/XJyFdVJ/SIMEXPRO-COMPACTO.png"
            alt="SIMEXPRO-COMPACTO"
            border="0"
          />
        </Grid>
      </Grid>
