...
namespace SIMEXPRO.DataAccess.Repositories.Adua
{
    public class DucaRepository : IRepository<tbDuca>
    {
        ...
        public RequestStatus InsertTap3(tbDocumentosDeSoporte item)
        {
            ...
            parameters.Add("@usua_UsuarioCreacio", item.usua_UsuarioCreacion, DbType.String, ParameterDirection.Input);
            parameters.Add("@doso_FechaCreacion", item.doso_FechaCreacion, DbType.String, ParameterDirection.Input);
