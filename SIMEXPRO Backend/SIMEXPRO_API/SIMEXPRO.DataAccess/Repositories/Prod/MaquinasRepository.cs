...
namespace SIMEXPRO.DataAccess.Repositories.Prod
{
    public class MaquinasRepository : IRepository<tbMaquinas>
    {
        public RequestStatus Delete(tbMaquinas item)
        {
            ...
            parametros.Add("@maqu_FechaEliminacion", item.maqu_FechaModificacion, DbType.DateTime, ParameterDirection.Input);
            var answer = db.QueryFirst<int>(ScriptsDataBase.EliminarMaquinas, parametros, commandType: CommandType.StoredProcedure);
        ...
        public RequestStatus Insert(tbMaquinas item)
        {
            ...
            var answer = db.QueryFirst<int>(ScriptsDataBase.InsertarMaquinas, parametros, commandType: CommandType.StoredProcedure);
            result.CodeStatus = answer;
            return result;
        }
        ...
        public RequestStatus Update(tbMaquinas item)
        {
            ...
            var answer = db.QueryFirst<int>(ScriptsDataBase.EditarMaquinas, parametros, commandType: CommandType.StoredProcedure);
            result.CodeStatus = answer;
            return result;
        }
    }
