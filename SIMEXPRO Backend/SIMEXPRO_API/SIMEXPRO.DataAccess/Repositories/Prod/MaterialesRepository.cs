...
namespace SIMEXPRO.DataAccess.Repositories.Prod
{
    public class MaterialesRepository : IRepository<tbMateriales>
    {
        public RequestStatus Delete(tbMateriales item)
        {
            ...
            var answer = db.QueryFirst<int>(ScriptsDataBase.EliminarMateriales, parametros, commandType: CommandType.StoredProcedure);
        ...
        public RequestStatus Insert(tbMateriales item)
        {
            ...
            var answer = db.QueryFirst<int>(ScriptsDataBase.InsertarMateriales, parametros, commandType: CommandType.StoredProcedure);
            result.CodeStatus = answer;
            return result;
        }
        ...
        public RequestStatus Update(tbMateriales item)
        {
            ...
            var answer = db.QueryFirst<int>(ScriptsDataBase.EditarMateriales, parametros, commandType: CommandType.StoredProcedure);
            result.CodeStatus = answer;
            return result;
        }
    }
