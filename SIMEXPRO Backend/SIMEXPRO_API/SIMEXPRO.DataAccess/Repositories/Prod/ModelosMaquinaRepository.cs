...
namespace SIMEXPRO.DataAccess.Repositories.Prod
{
    public class ModelosMaquinaRepository : IRepository<tbModelosMaquina>
    {
        public RequestStatus Delete(tbModelosMaquina item)
        {
            ...
            var answer = db.QueryFirst<int>(ScriptsDataBase.EliminarModelosMaquina, parametros, commandType: CommandType.StoredProcedure);
        ...
        public RequestStatus Insert(tbModelosMaquina item)
        {
            ...
            var answer = db.QueryFirst<int>(ScriptsDataBase.InsertarModelosMaquina, parametros, commandType: CommandType.StoredProcedure);
            result.CodeStatus = answer;
            return result;
        }
        ...
        public RequestStatus Update(tbModelosMaquina item)
        {
            ...
            var answer = db.QueryFirst<int>(ScriptsDataBase.EditarModelosMaquina, parametros, commandType: CommandType.StoredProcedure);
            result.CodeStatus = answer;
            return result;
        }
    }
