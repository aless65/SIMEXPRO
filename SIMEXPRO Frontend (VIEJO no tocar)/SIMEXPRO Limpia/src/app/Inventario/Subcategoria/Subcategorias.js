...
function SubcategoriaIndex() {
  ...
  const columns = [
    ...
    { field: 'subcategoria', headerName: 'SubCategoria', flex: 5,  },
    { field: 'categoria', headerName: 'Categoria', flex: 5,  },
    {
      field: 'acciones',
      headerName: 'Acciones',
      flex: 5, 
  ...
  {/* Datos de la tabla */ }
  const rows = [
    { id: '1', subcategoria: 'Algodón', categoria: 'Tela' },
    { id: '2', subcategoria: 'Metal', categoria: 'Boton' },
    { id: '3', subcategoria: 'Jean', categoria: 'Aguja' },
    { id: '4', subcategoria: 'Jean', categoria: 'Hilo' },
    { id: '5', subcategoria: '15 cm', categoria: 'Zipper' },
  ];
  ...
  const filteredRows = rows.filter((row) =>
    row.subcategoria.toLowerCase().includes(searchText.toLowerCase())
  );
