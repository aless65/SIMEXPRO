        ...
        <Card sx={{ minWidth: 275, margin: "40px" }}>
            <CardContent sx={{ textAlign: "center" }}>
                <Grid item xs={12}>
                    ...
                    >
                        Contrato De Adhesión Persona Juridica
                    </Typography>
                </Grid>
            </CardContent>
            ...
            <Box sx={{ bgcolor: "background.paper", width: "100%" }}>
                <AppBar position="static">
                    ...
                    >
                        ...
                        <Tab label="Domicilio de la Empresa" sx={{ fontSize: '16px' }}  {...a11yProps(1)} />
                ...
                >
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={6}>
                                <FormControl fullWidth>
                                    ...
                                    <Select style={{ borderRadius: "3px" }} required label="Estado civil del Representante Legal" />
                                </FormControl>
                            </Grid>
                            ...
                            <Grid item xs={6}>
                                <FormControl fullWidth>
                                    ...
                                    <Select style={{ borderRadius: "3px" }} required label=" Profesión u oficio  Representante Legal" />
                                    <Typography
                                        variant="body2"
                                        gutterBottom
                                        sx={{ textAlign: "justify", marginBottom: 5, color: '#575757' }}
                                    >
                                        (según clasificador nacional de ocupaciones de Honduras, CNOH-2018)
                                    </Typography>
                                </FormControl>
                            </Grid>
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    onClick={(e) => {
                                        Navigate("/ContratoDeAdhesionPersonaJuridica/Index");
                                    }}
                                >
                                    Cancelar
                                </Button>
                    ...
                    <TabPanel value={value} index={3} dir={theme.direction}>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={6}>
                                <FormControl fullWidth>
                                    <TextField style={{ borderRadius: "10px" }} required label="Número de teléfono fijo de la Empresa" />
                                </FormControl>
                            </Grid>
                            ...
                            <Grid item xs={6}>
                                <FormControl fullWidth>
                                    <TextField style={{ borderRadius: "10px" }} required label="Número de teléfono celular de la Empresa" />
                                </FormControl>
                            </Grid>

                            <Grid item xs={6}>
                                <FormControl fullWidth>
                                    <TextField style={{ borderRadius: "10px" }} required label="Número de teléfono celular del Representante Legal" />
                                </FormControl>
                            </Grid>
                    ...
                    <TabPanel value={value} index={4} dir={theme.direction}>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={6}>
                                <FormControl fullWidth>
                                    <TextField style={{ borderRadius: "10px" }} required label="Registro Tributario Nacional (RTN) de la Sociedad Mercantil" />
                                </FormControl>
                            </Grid>
                            ...
                            <Grid item xs={6}>
                                <FormControl fullWidth>
                                    <TextField style={{ borderRadius: "10px" }} required label="Escritura Pública de Constitución y sus modificaciones si las hubiera" />
                                    <Typography
                                        variant="body2"
                                        gutterBottom
                                        sx={{ textAlign: "justify", marginBottom: 5, color: '#575757' }}
