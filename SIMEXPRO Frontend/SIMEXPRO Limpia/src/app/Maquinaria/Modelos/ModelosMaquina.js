...
function ModelosIndex() {
  ...
  const columns = [
    ...
    { field: 'estilo', headerName: 'Estilo', flex: 1 },
    {
      field: 'acciones',
      headerName: 'Acciones',
      width: 400,
  ...
  {/* Datos de la tabla */ }
  const rows = [
    { id: '1', modelo: 'KS8327A', estilo: 'Manga corta' },
    { id: '2', modelo: 'NL7147Z', estilo: 'Manga larga' },
    { id: '3', modelo: 'VY4639H', estilo: 'Manga tres cuartos' },
  ...
  return (
    <Card sx={{ minWidth: 275, margin: '40px' }}>
      <CardMedia
        component="img"
        height="200"
        image="https://i.ibb.co/xDBDYyq/MODELOS-DE-M-QUINA.png"
