...
function OrdenCompra_Crear() {
  ...
  const rows = [{ id: '1', modelo: 'Polo', talla: 'L', progreso: 'no se que va aqui' }];
    ...
    <Card sx={{ minWidth: 275, margin: '40px' }}>
      ...
      <Box sx={{ bgcolor: 'background.paper', width: '100%' }}>
        ...
        >
          ...
          >
            <DialogTitle id="alert-dialog-title">Agregar Materiales a la Orden</DialogTitle>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={6}>
                      <FormControl fullWidth>
                        ...
                        <Select style={{ borderRadius: '3px' }} label="Material" />
                      </FormControl>
                    </Grid>
                    ...
                    <Grid item xs={6}>
                      <FormControl fullWidth>
                        ...
                        <Select style={{ borderRadius: '3px' }} label="Unidad de Medida" />
                      </FormControl>
                    </Grid>
                  </Grid>
                </DialogActions>
